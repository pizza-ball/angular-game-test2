...
import { Color3, Engine, FreeCamera, HemisphericLight, MeshBuilder, Scene, StandardMaterial, Texture, UniversalCamera, Vector3 } from '@babylonjs/core';
...
export class BackgroundService {
  ...
  public CreateScene(canvas: HTMLCanvasElement): Scene {
    ...
    var camera = new FreeCamera("camera", new Vector3(0, 10, startPoint.position.z), scene);
